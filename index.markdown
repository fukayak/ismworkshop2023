...
- 島谷健一郎（統数研）
    - [1日目スライド]({{ site.baseurl }}/assets/Shimatani.pptx)  
    - [2日目スライド]({{ site.baseurl }}/assets/Shimatani2.pdf){:target="_blank"}
　
- 大泉嶺（人口問題研究所）
...
- 香川幸太郎（遺伝研）
    ...
    - [講演スライド]({{ site.baseurl }}/assets/Kagawa.pdf){:target="_blank"}  
...
- 深澤圭太（環境研）
    ...
    - [講演スライド]({{ site.baseurl }}/assets/Fukasawa.pdf){:target="_blank"}  
